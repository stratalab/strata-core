...
use strata_engine::graph::types::{
    ...
    ObjectTypeDef, PageRankOptions, PageRequest, SsspOptions,
};
...
pub(super) fn graph_list(p: &Arc<Primitives>, branch: BranchId, space: String) -> Result<Output> {
    let core_branch = to_core_branch_id(&branch)?;
...
pub(super) fn graph_get_node_at(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_remove_node(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_list_nodes_at(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_list_nodes_paginated(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_remove_edge(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn graph_neighbors_at(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_bulk_insert(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_define_object_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_get_object_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_list_object_types(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_delete_object_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_define_link_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_get_link_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_list_link_types(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_delete_link_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_freeze_ontology(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_ontology_status(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_ontology_summary(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_list_ontology_types(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
...
pub(super) fn graph_nodes_by_type(
    p: &Arc<Primitives>,
    branch: BranchId,
    space: String,
    graph: String,
